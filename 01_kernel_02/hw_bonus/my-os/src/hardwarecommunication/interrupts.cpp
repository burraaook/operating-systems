...
const uint32_t MAX_INTERRUPT_NUMBER = 256;
...
CPUState* InterruptManager::ScheduleTransmitter(CPUState* esp)
{
    return taskManager->Schedule(esp);
}

uint32_t InterruptManager::GetInterruptCounter()
{
